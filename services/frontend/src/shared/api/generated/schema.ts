...
export interface components {
    schemas: {
        ...
        RecommendRequest: {
             ...
             *     after ranking (up to the server maximum, currently 400).
             */
            top_n?: number;
            /** @default true */
